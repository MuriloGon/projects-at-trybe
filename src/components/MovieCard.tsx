    ...
    return (
      <div className="card movie-card " data-testid="movie-card">
        ...
        <div className="movie-card-body card-content">
          <h4 data-testid="movie-card-title is-size-4" className="movie-card-title">{title}</h4>
          <h5 className="movie-card-subtitle is-size-5">{subtitle}</h5>
          <p className="movie-card-storyline is-size-6">{storyline}</p>
        </div>
